...
function displayBookmark(indexOfWebsite) {
  ...
  var newBookmark = `
              <tr>
                ...
                <td>
                  <button class="btn btn-success" data-index="${indexOfWebsite}">
                    <i class="fa-solid fa-eye pe-2"></i>Visit
                  </button>
                </td>
                <td>
                  <button class="btn btn-danger pe-2" data-index="${indexOfWebsite}">
  ...
  if (deleteBtns) {
    for (var R = 0; R < deleteBtns.length; R++) {
      deleteBtns[R].addEventListener("click", function (e) {
        deleteBookmark(e);
      });
    }
  }
  ...
  if (visitBtns) {
    for (var A = 0; A < visitBtns.length; A++) {
      visitBtns[A].addEventListener("click", function (e) {
        visitWebsite(e);
      });
    }
  }
